...
> **Nota sobre o LLVM:** O `llvmlite` instala sua própria versão minimalista do LLVM para gerar o código intermediário. Para executar os arquivos `.ll` gerados, você pode usar qualquer versão recente do interpretador `lli`, pois o código IR é retrocompatível.
